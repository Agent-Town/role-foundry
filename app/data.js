  ...
  teacher_source_intake: {
    ...
    sources: [
      ...
      },
      {
        ...
        status: 'promoted',
        manual_curation_only: false,
        promoted_family: 'rf.frontend-apprentice.public.code-review-discipline',
        episode_count: 2,
        summary: 'Code review heuristics for diff critique, test expectations, and scope control. Promoted as a public family with 2 RF-authored episodes grounded in existing RF screens.',
      },
      {
        id: 'intake-alpinejs-curation',
        name: 'Alpine.js docs + examples',
        license: 'MIT',
        status: 'promoted',
        manual_curation_only: true,
        promoted_family: 'rf.frontend-apprentice.public.alpine-state-patterns',
        episode_count: 2,
        summary: 'Stack-adjacent Alpine state/visibility patterns. Promoted via manual rewrite from Alpine docs/examples only; raw GitHub issue/PR/review text remains excluded.',
      },
      {
