...
- [ ] ERC-8004 Base minting still requires: configured `BASE_SEPOLIA_RPC_URL` (or mainnet equivalent), `agent0-sdk` in the Python environment, a signer private key, a public token URI hosting the draft JSON, `ROLE_FOUNDRY_ERC8004_ENABLE_LIVE_MINT=1`, and a human promotion/public-issuance decision.
